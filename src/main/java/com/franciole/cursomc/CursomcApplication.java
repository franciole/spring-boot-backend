...
public class CursomcApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardin", "32880834", cli1, c1);
        ...
        Pedido ped1 = new Pedido(null, sdf.parse("30/09/2025 10:32"), cli1, e1);
        Pedido ped2 = new Pedido(null, sdf.parse("10/10/2025 19:35"), cli1, e2);
